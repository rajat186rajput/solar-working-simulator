...
export function TopBar() {
  const { resetToDefault, systemOffline, inverterOverload, systemStatus } = useSimStore();

  const hasAlert = systemOffline || inverterOverload;

  return (
    <header className="flex items-center justify-between px-3 sm:px-4 border-b border-surface-stroke bg-surface-dark/95 backdrop-blur-md h-14 shrink-0 gap-2">
      {/* Left — logo */}
